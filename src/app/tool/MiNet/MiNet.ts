...
export class MiNet {
    ...
    constructor(user: User) {
        ...
        this.user = user;
        this.miApi = new MiApi(user.token);
    }
    ...
    async q_incrate_mirate(proc: string, type: number, marketmin: number, marketmax: number) {
        return await this.miApi.call(proc, [type, marketmin, marketmax])
    }
}
